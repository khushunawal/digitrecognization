...
def import_and_predict(image_data):
  ...
  prediction = model.predict(image_resized.reshape(-1, 28, 28, 1))
...
if st.button("About"):
  st.header(" khushboo")
  st.subheader(" Professor,  Computer Engineering")
...
html_temp = """
   ...
   <center><p style="font-size:20px;color:white;margin-top:10px;">khushboo</p></center> 
   </div>
   </div>
   </div>
   """
